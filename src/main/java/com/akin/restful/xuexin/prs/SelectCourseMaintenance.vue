    ...
    <el-row class="text-align-left">
      <el-col :span="24">
        ...
        <el-col :span="4" class="margin-top">
          <!--:xl="3" :lg="4" :offset="1"-->
          <el-form label-width="70px" label-position="left" :model="searchSelectedCourse" ref="searchForm">
            <el-form-item label="课程代码">
              <el-input v-model="searchSelectedCourse.courseCode"></el-input>
            </el-form-item>
            <el-form-item label="课程名称">
              <el-input v-model="searchSelectedCourse.courseName">'</el-input>
            </el-form-item>
            <el-form-item label="教师工号">
              <el-input v-model="searchSelectedCourse.teacherNo"></el-input>
            </el-form-item>
            <el-form-item label="教师姓名">
              <el-input v-model="searchSelectedCourse.teacherName"></el-input>
            </el-form-item>
            <el-form-item label="学年">
              <el-select v-model="searchSelectedCourse.academicYear" filterable placeholder="请选择">
                <el-option v-for="item in academicYearOptions" :key="item.name" :label="item.name" :value="item.name"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="学期">
              <el-radio-group v-model="searchSelectedCourse.term" size="small">
            ...
            <el-form-item label="课程性质">
              <el-select v-model="searchSelectedCourse.courseType" filterable placeholder="请选择">
                <el-option v-for="item in courseTypeOptions" :key="item.name" :label="item.name" :value="item.name"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="学分">
              <el-select v-model="searchSelectedCourse.credit" filterable placeholder="请选择">
  ...
  export default {
    ...
    methods: {
      ...
      async queryCourse() {
        ...
        let courseListData = await findCoursesByConditions(this.searchSelectedCourse);
